...
var (
	...
	helmchn = &chnv1.Channel{
		...
		Spec: chnv1.ChannelSpec{
			Type:     "HelmRepo",
			Pathname: "https://open-cluster-management.io/multicloud-operators-subscription/test/helm",
		},
	}
...
func TestCreateOrUpdateHelmChart(t *testing.T) {
	...
	g.Expect(helmrelease.Repo.Source.HelmRepo.Urls[0]).
		Should(gomega.Equal(
			"https://open-cluster-management.io/multicloud-operators-subscription/test/helm/my-app-0.1.0.tgz"))
