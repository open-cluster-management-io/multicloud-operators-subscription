...
func (obsi *SubscriberItem) doSubscription() {
	...
	if err := obsi.synchronizer.ProcessSubResources(obsi.Subscription, resources, allowedGroupResources,
		deniedGroupResources, false, utils.CheckoutSummary{}); err != nil {
		klog.Error(err)
